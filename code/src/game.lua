...
function Menu:draw()
    ...
    love.graphics.setColor(255, 255, 255)
    love.graphics.printf('COIN-CATCHER', nativeCanvasWidth / 2 - 600, nativeCanvasHeight / 2 - 200, 1200, 'center')

    -- press start
    if math.cos(2 * math.pi * love.timer.getTime()) > 0 then
        love.graphics.setFont(fonts.large)
        love.graphics.setColor(255, 255, 255)
        love.graphics.printf('PRESIONA ENTER', nativeCanvasWidth / 2 - 500, nativeCanvasHeight / 2 + 50, 1000, 'center')
    end
end
...
function GameOver:draw()
    ...
    love.graphics.setFont(fonts.large)
    love.graphics.setColor(255, 255, 255)
    love.graphics.printf('TU PUNTAJE: ' .. self.score .. '!', nativeCanvasWidth / 2 - 500, nativeCanvasHeight / 2 - 100, 1000, 'center')
end
