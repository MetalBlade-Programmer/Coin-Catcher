...
function love.load()
    ...
    images.rcoin = love.graphics.newImage('assets/images/rcoin.png')
    images.lcoin = love.graphics.newImage('assets/images/lcoin.png')
    images.coin = love.graphics.newImage('assets/images/coin.png')
    images.scoin = love.graphics.newImage('assets/images/scoin.png')
    ...
    sounds.rcoin = love.audio.newSource('assets/sounds/coin.ogg', 'static')
    sounds.lcoin = love.audio.newSource('assets/sounds/coin.ogg', 'static')
    sounds.coin = love.audio.newSource('assets/sounds/coin.ogg', 'static')
    sounds.scoin = love.audio.newSource('assets/sounds/coin.ogg', 'static')
